            ...
            @foreach ($companies as $companies)
                <div class="max-w-sm overflow-hidden bg-white rounded shadow-lg dark:bg-gray-800">
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        <a href=" {{ route('company.show', $companies->id) }} "class="px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                            Show
                        </a>
